      ...
      >
        <div
          className={cn(
            ...
            "group-data-[variant=floating]:m-2 group-data-[variant=inset]:my-2",
             ...
             "bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow",
              "group-data-[variant=inset]:w-[calc(var(--sidebar-width)_-_theme(spacing.4))] group-data-[variant=inset][data-collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+2px)]",
            className
          )}
          {...props}
        >
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col transition-[margin-left] duration-200",
        "peer-data-[state=expanded]:peer-data-[side=left]:ml-[--sidebar-width]",
        "peer-data-[state=collapsed]:peer-data-[collapsible=icon]:peer-data-[side=left]:ml-[--sidebar-width-icon]",
        "peer-data-[variant=inset]:peer-data-[state=expanded]:peer-data-[side=left]:ml-[calc(var(--sidebar-width)_-_theme(spacing.4))]",
        "peer-data-[variant=inset]:peer-data-[state=collapsed]:peer-data-[collapsible=icon]:peer-data-[side=left]:ml-[--sidebar-width-icon]",
        className
      )}
      {...props}
    />
